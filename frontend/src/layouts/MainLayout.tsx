...
const navItems = [
  ...
  { to: '/violations', label: 'Violations', icon: 'M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-2.5L13.732 4.5c-.77-.833-2.694-.833-3.464 0L3.34 16.5c-.77.833.192 2.5 1.732 2.5z' },
...
export default function MainLayout() {
  return (
    <div className="flex h-screen bg-primary-900">
      {/* Sidebar */}
      <aside className="w-64 bg-primary-950 border-r border-primary-800 flex flex-col">
        {/* Logo */}
        <div className="px-6 py-5 border-b border-primary-800">
          <h1 className="text-xl font-bold text-white flex items-center gap-2">
            <svg className="w-7 h-7 text-accent-indigo-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <NavLink
              ...
              className={({ isActive }) =>
                `flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-colors ${
                  isActive
                    ? 'bg-accent-indigo-600 text-white'
        ...
        <div className="px-6 py-4 border-t border-primary-800">
          <p className="text-xs text-primary-500">TrafficVision AI v0.1.0</p>
        </div>
      </aside>
